...
from D2D_code.units import get_all_input, last_value
...
if __name__ == '__main__':
    ...
    parser.add_argument('--label_path', type=str, default='./spatio-temporal net/d2d_data_delavg_hott/app_label_0.npy')
    parser.add_argument('--graphs_path', type=str,
                        default='./spatio-temporal net/d2d_data_delavg_hott/app_sub_net_0.npy')
    parser.add_argument('--input_path', type=str, default='./spatio-temporal net/d2d_data_delavg_hott/app_feature_0.npy')
    ...
    print('size of labels:{}\n, size of inputs feature mat:{}'.format(len(labels), len(inputs)))
    ...
    data_loader = DataLoader(data, batch_size=2000, shuffle=False, collate_fn=collate_fn)
    ...
    plt.legend()
    plt.savefig('C:/Users/Public/Desktop/cate' + str(save_cate) + 'train_d2d.png', bbox_inches='tight')
    plt.clf()  # 防止图片叠加

    plt.title('test f1_socre')
    plt.plot(test_score, label='f1_score', color="#DB7093")
    plt.legend()
    plt.savefig('C:/Users/Public/Desktop/cate' + str(save_cate) + 'test_d2d.png', bbox_inches='tight')
    plt.clf()  # 防止图片叠加
